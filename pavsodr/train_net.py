...
# Respect user-specified CUDA_VISIBLE_DEVICES; only default to "0,1" if not set.
...
from pavsodr_model import (
    PAVSODRDatasetMapper,
    add_model_config_soundnet,
...
class Trainer(DefaultTrainer):
    ...
    def build_train_loader(cls, cfg):
        ...
        mapper = PAVSODRDatasetMapper(cfg, is_train=True)
