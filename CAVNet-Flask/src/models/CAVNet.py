...
class cavnet(nn.Module):
    ...
    def initialize_pretrain(self):
        backbone_pretrain = torch.load('src\CAV-Net_models\pretrain\static_visual_pretrain.pth')
    ...
    def initialize_soundnet(self):
        audio_pretrain_weights = torch.load('src\CAV-Net_models\pretrain\soundnet8.pth')
