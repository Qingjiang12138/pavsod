...
parser.add_argument('--tr_root', type=str, default=os.getcwd() + '/src/data/PAVS10K_seqs_train.txt', help='')
parser.add_argument('--te_root', type=str, default=os.getcwd() + '/src/data/PAVS10K_seqs_test.txt', help='')
