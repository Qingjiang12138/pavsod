...
parser.add_argument('--test_path', type=str, default=os.getcwd() + '/src/data/', help='test dataset path')
...
# load the model
model = cavnet()
model.load_state_dict(torch.load(os.getcwd() + '/src/CAV-Net_models/final/CAVNet_final.pth'))
model.cuda()
model.eval()
